...
def enhancedFeatureExtractorDigit(datum):
    ...
    1. Number of breaks in horizontal/vertical spaces
    2. Aspect ratio of digit
...
def readCommand( argv ):
    ...
    parser.add_option('-c', '--classifier', help=default('The type of classifier'), choices=['mostFrequent', 'nb', 'nn', 'naiveBayes', 'perceptron', 'neuralNetwork'], default='mostFrequent')
    parser.add_option('-d', '--data', help=default('Dataset to use'), choices=['digits', 'faces'], default='digits')
    parser.add_option('-t', '--training', help=default('The size of the training set'), default=100, type="int")
    #parser.add_option('-f', '--features', help=default('Whether to use enhanced features'), default=False, action="store_true")
    parser.add_option('-f', '--features', help=default('The type of features'), choices = ['basic', 'enhanced', 'sobel'], default='basic')
    ...
    if(options.data=="digits"):
        ...
        if (options.features == "enhanced"):
            featureFunction = enhancedFeatureExtractorDigit
        elif (options.features == "basic"):
        ...
        elif (options.features == "enhanced"):
    ...
    if(options.classifier == "mostFrequent"):
        ...
        import neuralNetwork
        classifier = neuralNetwork.NeuralNetworkClassifier(legalLabels, options.iterations, options.alpha)
        print "learning rate for Neural Network: ", options.alpha
    else:
...
def runClassifier(args, options):
    ...
    print("Testing Complete: %.3f seconds" % (time.time() - startTime))
